...
/* ============================================================
   P4.5 v30 — deployment repair bridge
   ...
   ============================================================ */
(function(){"use strict";
  window.HT=window.HT||{};HT.RELEASE=30;
...
(function(){
  ...
  function clarifyGamification(){
    ...
    const answered=$("#stAnswered");const answeredLabel=answered&&answered.parentElement&&answered.parentElement.querySelector(".l");if(answeredLabel)answeredLabel.textContent="questions gamifiées";
  }
...
/* ============================================================
   v30.11 — remaining-content + dashboard-visual QA hotfix
   - visible/accessible Part 1–7 skill-bar fills on the dashboard
   - homepage question counter explicitly scoped to gamified practice
   - paired with Phrasal Verb City separable-pronoun content repair
   ============================================================ */
