#!/usr/bin/env node
/* Homemade TOEIC Trainer — zero-regression QA v30. No dependencies. */
...
let sys=text('system-check.html');if(sys){if(!/Quality check v30/.test(sys)||!/homemade-toeic-v30/.test(sys)||!/Progression unifiée/.test(sys))err('System Check: v30/progress checks missing');else ok()}
