/* Homemade TOEIC Trainer — service worker v14
   Adds Corporate Mysteries and Successful TOEIC Kingdom to the offline page cache. */
const CACHE = "homemade-toeic-v14";
const ASSETS = [
